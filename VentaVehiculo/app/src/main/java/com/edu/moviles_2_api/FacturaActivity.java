...
public class FacturaActivity extends AppCompatActivity {
    ...
    public void BusarFactura(View view) {
        ...
        }
        {
            ...
            String query = String.format("SELECT fa.cod_factura, fa.fecha, fa.placa, fa.activo, ve.valor, ve.marca, ve.modelo FROM TblFactura fa inner join TblVehiculo ve on (ve.placa = fa.placa) WHERE cod_factura =  '%s'", nfactura);
            Cursor fila = db.rawQuery(query, null);
            if (fila.moveToNext()) {
                numeroFactura.setText(fila.getString(0));
                fechaFactura.setText(fila.getString(1));
                placaehiculo.setText(fila.getString(2));
                activoFactura.setChecked(fila.getString(3).equals("si"));
                valorvehiculo.setText(fila.getString(4));
                marcaVehiculo.setText(fila.getString(5));
                modeloVehiculo.setText(fila.getString(6));
            } else {
